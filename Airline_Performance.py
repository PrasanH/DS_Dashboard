...
app.layout = html.Div(children=[ 
                                ...
                                html.Div([
                                    # Add a division
                                    html.Div([
                                        # sub division 1 for dropdown for report type
                                        html.Div(
                                            [
                                          ...
                                          dcc.Dropdown(id='input-type', 
                                                        ...
                                                        style={'width':'60%', 'padding':'2px', 'font-size':'20px', 'text-align-last':'center'}),
                                    # Place them next to each other using the division style ( some other options are inline, inline-table)
                                               ], style={'display':'flex'}),
                                    
                                   # subdivision 2 for choosing year 
                                   html.Div([
                                        html.Div(
                                            [
                                            html.H2('Select a Year:', style={'margin-right': '2em'})
                                            ]
                                                ),
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':    #defined OPT1 and OPT2 in dropdowns
